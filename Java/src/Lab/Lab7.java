...
public class Lab7 {
    ...
    +-----------------------------------------+
    """);
            int choice = (int)Validation.getValidDouble("Mời bạn nhập số: ",1,5,true);
            switch (choice){
                case 1:
                    String identity = Validation.getValidString("Mời nhập CCCD: ");
                    ShowResult.showResult(IndentityValidator.isValidIdentity(identity),"CCCD");
                    break;
                case 2:
                    String email = Validation.getValidString("Mời nhập Email: ");
                    ShowResult.showResult(EmailValidator.isValidEmail(email),"Email");
                    break;
                case 3:
                    String phone = Validation.getValidString("Mời nhập SDT: ");
                    ShowResult.showResult(PhoneValidator.isValidPhone(phone),"SDT");
                    break;
                case 4:
                    String password= Validation.getValidString("Mời nhập password: ");
